...
Remerciements tout particulièrement à Karine Gendron.
...
Il semble parfois que nous[^1] ayons oublié que même un texte numérique est une inscription dans une matière.

[^1]: Je dis nous mais libres à vous de ne pas vous sentir concernés.
...
Mon texte numérique publié en ligne, comme celui-ci, si je montre [l'envers](view-source:https://blank.blue/conf/intranquille/), c'est un texte, des écritures en HTML qui sont là.
...
Comment se fait-il que si je suis la personne qui a bien écrit mon texte sur mon clavier sur ma machine, comment se fait-il que je n'ai aucun pouvoir sur sa survie et que Paul Allen et Bill Gates, que je n'ai jamais rencontré, qui n'ont jamais écrit sur ma machine, sont dépositaires de mon écriture ?[^2]

[^2]: Sans chercher de coupable, en utilisant Word, c'est en réalité le contrat tacite que je passe avec Bill et Paul.
